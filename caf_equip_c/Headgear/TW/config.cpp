class CfgPatches
{
	...
	{
		units[] = {};
		weapons[] = {"H_CAF_CREWHELMET","H_CAF_Boonie_TW","H_CAF_Boonie_hs_TW","H_CAF_CG634_TW","H_CAF_CG634_TW_G_U","H_CAF_CG634_TW_G_D","H_CAF_CG634_NET_TW","H_CAF_CG634_NET_TW_G_U","H_CAF_CG634_NET_TW_G_D","H_CAF_CG634_SCRIM_TW","H_CAF_CG634_SCRIM_TW_G_U","H_CAF_CG634_SCRIM_TW_G_D"};
		requiredVersion = 0.1;
...
class cfgWeapons
{
	...
	class H_CAF_Boonie_TW : H_Booniehat_khk {
		...
		hiddenSelectionsTextures[] = {"\caf_equip_t\tex\booniehat_temperate_co.paa"};
	...
	class H_CAF_CG634_TW_BASE: H_HelmetB
	{
		...
		hiddenSelectionsTextures[] = {"\caf_equip_t\tex\cg634_tw_co.paa","\caf_equip_t\tex\tex\tex2_co.paa","","",""};
		class ItemInfo: HeadgearItem
		{
			mass = 60;
	...
	class H_CAF_CG634_NET_TW_BASE: H_HelmetB
	{
		...
		hiddenSelections[] = {"camo","goggles_up","camo2","camo2b","camolens"};
			hiddenSelectionsTextures[] = {"\caf_equip_t\tex\cg634_tw_net_co.paa","\caf_equip_t\tex\tex\tex2_co.paa","\caf_equip_t\tex\tex2_co.paa","","",""};
		class ItemInfo: HeadgearItem
		{
			mass = 60;
			...
			passThrough = 0.5;
			hiddenSelections[] = {"camo","goggles_up","camo2","camo2b","camolens"};
			hiddenSelectionsTextures[] = {"\caf_equip_t\tex\cg634_tw_net_co.paa","\caf_equip_t\tex\tex\tex2_co.paa","\caf_equip_t\tex\tex2_co.paa","\caf_equip_t\tex\tex3_co.paa","#(argb,8,8,3)color(0,0,0,0.3,ca)"};
		};
	};
	...
	class H_CAF_CG634_NET_TW: H_CAF_CG634_NET_TW_BASE
	{
		...
		hiddenSelections[] = {"camo","goggles_up","camo2","camo2b","camolens"};
		hiddenSelectionsTextures[] = {"\caf_equip_t\tex\cg634_tw_net_co.paa","","","",""};
		class ItemInfo: HeadgearItem
		{
			mass = 60;
			uniformModel = "\caf_equip\CG634_NET.p3d";
	...
	class H_CAF_CG634_NET_TW_G_U: H_CAF_CG634_NET_TW_BASE
	{
		...
		picture = "\caf_equip_t\inv\INV_CG634_NET_TW_G_U_CA.paa";
		hiddenSelections[] = {"camo","goggles_up","camo2","camo2b","camolens"};
		hiddenSelectionsTextures[] = {"\caf_equip_t\tex\cg634_tw_net_co.paa","\caf_equip_t\tex\tex2_co.paa","","",""};
		class ItemInfo: HeadgearItem
		{
			mass = 60;
			uniformModel = "\caf_equip\CG634_NET.p3d";
			...
			passThrough = 0.5;
			hiddenSelections[] = {"camo","goggles_up","camo2","camo2b","camolens"};
			hiddenSelectionsTextures[] = {"\caf_equip_t\tex\cg634_tw_net_co.paa","\caf_equip_t\tex\tex\tex2_co.paa","","",""};
		};
	};
	...
	class H_CAF_CG634_NET_TW_G_D: H_CAF_CG634_NET_TW_BASE
	{
		...
		hiddenSelections[] = {"camo","goggles_up","camo2","camo2b","camolens"};
		hiddenSelectionsTextures[] = {"\caf_equip_t\tex\cg634_tw_net_co.paa","","\caf_equip_t\tex\tex2_co.paa","\caf_equip_t\tex\tex3_co.paa","#(argb,8,8,3)color(0,0,0,0.3,ca)"};
		class ItemInfo: HeadgearItem
		{
			mass = 60;
			uniformModel = "\caf_equip\CG634_NET.p3d";

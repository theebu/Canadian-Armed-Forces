...
class CfgVehicles
{
	...
	class CAF_LAV3_base_F: Car_F
	{
		model 	= "\A3\Samples_f\Test_Car_01\Test_Car_01";  /// simple path to model
		...
		displayName = "LAV3"; /// displayed in Editor
		
		hiddenSelections[] = {"camo1","camo2","camo3"}; ///we want to allow changing of colours
